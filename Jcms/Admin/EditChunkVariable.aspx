<%@ Page Title="" ValidateRequest="false" Language="VB" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="false" CodeFile="EditChunkVariable.aspx.vb" Inherits="Admin_EditChunkVariable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentRight" Runat="Server">
				...
				<div style="display: none;">	
					...
					<div class="form">
						<p><asp:Literal ID="litDescriptionEditChunk" runat="server"></asp:Literal></p>
 						<div class="clear"></div>	
					</div>
					...
					<div class="form textarea">				
						<div class="label"><asp:Literal ID="litTextChunk" runat="server"></asp:Literal></label></div>
						<div class="input"><asp:TextBox ID="txtChunk" runat="server" TextMode="MultiLine" Rows="20"></asp:TextBox></div>
  						<div class="clear"></div>	
					</div> 
					
					<div class="form last">				
						<asp:Button ID="btnSalvaModificheChunk" runat="server" Text="" CssClass="submit" />
  						<div class="clear"></div>	
					</div> 	
<div>
