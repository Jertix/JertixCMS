<%@ Page Title="" ValidateRequest="false" Language="VB" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="false" CodeFile="EditTemplateVariable.aspx.vb" Inherits="Admin_EditTemplateVariable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentRight" Runat="Server">
				...
				<div style="display: none;">	
					...
					<div class="form">
						<p><asp:Literal ID="litDescriptionEditTemplateVariable" runat="server"></asp:Literal></p>
 						<div class="clear"></div>	
					</div>
					...
					<asp:Panel ID="panelElencoTemplate" runat="server"></asp:Panel>
 						<div class="clear"></div>	
					</div>	 
					
					<asp:Literal ID="imgPanelElencoTemplate" runat="server"></asp:Literal>
