...
Partial Class Admin_AddTemplateVariable
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Else
                DropDownListCategorieTemplateVariable.SelectedIndex = DropDownListCategorieTemplateVariable.Items.IndexOf(DropDownListCategorieTemplateVariable.Items.FindByValue(Request.QueryString("idCat")))
                DropDownListCategorieTemplateVariable.SelectedValue = Request.QueryString("idCat")
    ...
    Private Sub InitPage()
        ...
        myMasterPage.PageTitle.Text = Admin.litH1AddTemplateVariable
    End Sub

    Private Sub LoadLabels()
        litDescriptionAddTemplateVariable.Text = Admin.litDescriptionAddTemplateVariable
    ...
    Protected Sub btnSalvaNuovoTemplateVariable_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSalvaNuovoTemplateVariable.Click
        If jCMS.TemplateVariableNameExist(txtTemplateVariableName.Text, DropDownListCategorieTemplateVariable.SelectedValue) = False Then
                ...
                If txtTemplateVariableCaption.Text.Trim.Length > 0 Then
                    If DropDownListCategorieTemplateVariable.SelectedValue > 0 Then
                        If jCMS.CountTemplateChecked(panelElencoTemplate) > 0 Then
                            jCMS.SaveTemplateVariable(txtTemplateVariableName.Text, txtTemplateVariableCaption.Text, txtTemplateVariableDescription.Text, DropDownListCategorieTemplateVariable.SelectedValue, DropDownListTipiTemplateVariable.SelectedValue, panelElencoTemplate)
